function LoadImg(a) {
    this._items = Array.prototype.slice.call(document.querySelectorAll(a)), this._innerHeight = window.innerHeight - 55;
    var b = this;
    this._resizeFn = function() {
        b._innerHeight = window.innerHeight - 55
    }, window.addEventListener("resize", this._resizeFn, !1)
}
function VideoList() {
    this._canPlay = !0
}
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(a) {
    ...
    try {
...
}(Zepto), LoadImg.prototype = {done: function(a) {
        var b = this._first();
        if (b) {
            if ($(b).offset().top - this._innerHeight <= a) {
                var c = this._pop(), d = new Image, e = this;
                d.onload = function() {
                    d.onload = null, c.appendChild(this), c.removeChild(c.querySelector(".bounce")), e._event && "append" in e._event && e._event.append.forEach(function(a) {
                        a(d)
                    })
                }, d.src = c.getAttribute("data-img"), this.done(a)
            }
            return this
        }
    },init: function() {
        var a = this;
        return this._items.forEach(function(b) {
            b.appendChild(a.html())
        }), $(window).scroll(function() {
            a.done($(this).scrollTop())
        }).scroll(), this
    },on: function(a, b) {
        return this._event || (this._event = {}), this._event[a] || (this._event[a] = []), this._event[a].push(b), this
    },html: function() {
        var a = document.createElement("div");
        a.className = "bounce";
        for (var b = 1; 3 >= b; b++) {
            var c = document.createElement("div");
            c.className = "bounce-container container" + b;
            for (var d = 1; 4 >= d; d++) {
                var e = document.createElement("div");
                e.className = "circle" + d, c.appendChild(e)
            }
            a.appendChild(c)
        }
        return a
    },destroy: function() {
        window.removeEventListener("resize", this._resizeFn, !1)
    },_first: function() {
        return this._items[0]
    },_pop: function() {
        return this._items.shift()
    }}, VideoList.prototype = {_create: function(a, b, c) {
        function d() {
            b && b(), e.removeEventListener("durationchange", d, !1)
        }
        var e = document.createElement("video");
        return e.src = a, e.loop = "loop", c && e.addEventListener("durationchange", d, !1), e
    },init: function(a) {
        function b(a) {
            a.preventDefault()
        }
        function c(a) {
            var c = $(a);
            document.addEventListener("touchmove", b, !1), g.show().append(c).removeClass("pop-out").addClass("pop-in"), c.click(function() {
                return !1
            })
        }
        function d() {
            document.removeEventListener("touchmove", b, !1), g.removeClass("pop-in").addClass("pop-out"), setTimeout(function() {
                g.hide()
            }, 250)
        }
        var e = $("#warp"), f = this;
        if (a) {
            var g = $("#android_video_wrap");
            g.delegate("video", "click", function() {
                return !1
            }), g.click(function() {
                d(), g.find("video").unbind("click").remove()
            })
        }
        e.delegate(".medias .btn-play", "click", function() {
            if (f._canPlay) {
                f._canPlay = !1;
                var b = $(this), d = b.attr("data-init");
                if ("1" != d) {
                    var e = b.attr("data-video"), g = f._create(e, function() {
                        f._canPlay = !0
                    }, !a);
                    var type = b.attr("data-type");
                    if (type == 'AUDIO') {
                        $('.android-video-wrap .preview').show();
                    }
                    a ? (g.controls = "controls", g.width = 480, g.height = 480, f._canPlay = !0, c(g)) : (g = document.getElementById("preloadVideo"), b.attr("data-init", "1"), f._canPlay = !0), g.play()
                } else
                    b.parent().find("video").get(0).play(), f._canPlay = !0;
                return !1
            }
        });
    }};
